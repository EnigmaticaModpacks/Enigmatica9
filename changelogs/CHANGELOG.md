...
-   [Expert] End Crystals are now more expensive [\#776](https://github.com/EnigmaticaModpacks/Enigmatica9/issues/776)
-   [Expert] Spawner Core Shells are now less expensive, crafting in batches of four [\#776](https://github.com/EnigmaticaModpacks/Enigmatica9/issues/776)
...
-   Reinstated proper names for custom blocks/items/fluids that were previously autogenerated by KubeJS [\#737](https://github.com/EnigmaticaModpacks/Enigmatica9/issues/737)
-   [Expert] - Because Heart of the Sea refuses to stop spawning where it shouldn't, the Vanilla item has been renamed to Blue Pearl. A new Heart of the Sea item has been created to replace it. [\#737](https://github.com/EnigmaticaModpacks/Enigmatica9/issues/737)
-   [Expert] - EMI breaks visibility of biome list from industrial forgoing [\#734](https://github.com/EnigmaticaModpacks/Enigmatica9/issues/734)
-   [Expert] - Problem with Soul engulfing structure in JEI [\#727](https://github.com/EnigmaticaModpacks/Enigmatica9/issues/727)

---

### Enigmatica 9 v1.15.0

🚀 Forge-1.19.2-43.2.14 | [📜 Mod Updates](https://github.com/EnigmaticaModpacks/Enigmatica9/blob/master/changelogs/changelog_mods_1.15.0.md) | [📋 Modlist](https://github.com/EnigmaticaModpacks/Enigmatica9/blob/master/changelogs/modlist_1.15.0.md)
...
-   Fixed middle-click crafting not working in AE2 terminals
...
🚀 Forge-1.19.2-43.2.14 | [📜 Mod Updates](https://github.com/EnigmaticaModpacks/Enigmatica9/blob/master/changelogs/changelog_mods_1.12.1.md) | [📋 Modlist](https://github.com/EnigmaticaModpacks/Enigmatica9/blob/master/changelogs/modlist_1.12.1.md)
...
-   Fixed typos in quests [\#653](https://github.com/EnigmaticaModpacks/Enigmatica9/pull/653) ([MuteTiefling](https://github.com/MuteTiefling))
...
-   [Expert] Attempting to teleport to the bumblezone early will now prompt the player for the correct block under it. [\#612](https://github.com/EnigmaticaModpacks/Enigmatica9/pull/612) ([MuteTiefling](https://github.com/MuteTiefling))
...
-   Fixed Quark Ancient Leaves inadvertently dropping the wrong items. [\#620](https://github.com/EnigmaticaModpacks/Enigmatica9/pull/620) ([MuteTiefling](https://github.com/MuteTiefling))
...
-   Mekanism Quest Refresh [\#106](https://github.com/EnigmaticaModpacks/Enigmatica9/pull/106) ([MuteTiefling](https://github.com/MuteTiefling))
-   PneumaticCraft Quest refresh [\#92](https://github.com/EnigmaticaModpacks/Enigmatica9/pull/92) ([MuteTiefling](https://github.com/MuteTiefling))
-   Nature's Aura Quest Refresh [\#91](https://github.com/EnigmaticaModpacks/Enigmatica9/pull/91) ([MuteTiefling](https://github.com/MuteTiefling))
...
-   Custom main menu doesn't work on CF Distribution. [\#100](https://github.com/EnigmaticaModpacks/Enigmatica9/issues/100)
-   Player that have OP permissions on the server are being kicked from the server. [\#73](https://github.com/EnigmaticaModpacks/Enigmatica9/issues/73)
-   Shut-Up experimental settings not working while creating new world. [\#72](https://github.com/EnigmaticaModpacks/Enigmatica9/issues/72)
-   Twilight Forest Portal cannot be formed [\#67](https://github.com/EnigmaticaModpacks/Enigmatica9/issues/67)
...
_Using Forge-1.19.2-43.1.34_ | _[Modlist](https://github.com/EnigmaticaModpacks/Enigmatica9/blob/master/changelogs/modlist_1.0.0.md)_
