...
$MODPACK_NAME = "Enigmatica9"

# Name of the Modpack in the ZIP File
$CLIENT_NAME = "Enigmatica9"

# Version Of The Modpack
$MODPACK_VERSION = "1.23.2"

# Last Version Of The Modpack
# Needed For Changelog Parsing
$LAST_MODPACK_VERSION = "1.23.1"
...
$CLIENT_FILE_DISPLAY_NAME = "Enigmatica 9 $MODPACK_VERSION"
...
$SERVER_FILE_DISPLAY_NAME = "Enigmatica 9 Server $MODPACK_VERSION"
