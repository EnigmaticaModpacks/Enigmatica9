ServerEvents.tags('item', (event) => {
    event.add(
        'sophisticatedstorage:storage_wooden',
        '#sophisticatedstorage:base_tier_wooden_storage',
        'sophisticatedstorage:basic_tier_upgrade',
        'sophisticatedstorage:shulker_box'
    );
    event.add(
        'sophisticatedstorage:storage_iron',
        /sophisticatedstorage:iron_/,
    ...
    event.add(
        'sophisticatedstorage:storage_gold',
        /sophisticatedstorage:gold_/,
    ...
    event.add(
        'sophisticatedstorage:storage_diamond',
        /sophisticatedstorage:diamond_/,
    ...
    event.add(
        'sophisticatedstorage:storage_netherite',
        /sophisticatedstorage:netherite_/,
