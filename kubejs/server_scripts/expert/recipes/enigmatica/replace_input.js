ServerEvents.recipes((event) => {
    ...
    const recipes = [
        { filter: { output: 'minecraft:hopper' }, to_replace: '#forge:ingots/iron', replace_with: '#forge:plates/tin' },
        { filter: { output: 'minecraft:bucket' }, to_replace: '#forge:ingots/iron', replace_with: '#forge:plates/tin' },
        {
            filter: { mod: 'create' },
        ...
        { filter: { mod: 'create' }, to_replace: 'minecraft:dried_kelp', replace_with: '#forge:leather' },
        {
            filter: { id: 'twilightforest:carminite_reactor' },
            to_replace: '#forge:ores/redstone',
            replace_with: '#forge:storage_blocks/source'
        },
        { filter: { mod: 'pneumaticcraft' }, to_replace: '#c:glass_blocks', replace_with: 'ae2:quartz_glass' },
        {
